...
case "$1" in
	-i)
		LOGFILE=initial_disk_tokenmap_pernode_$TSTAMP.txt
	;;
	-c)
		LOGFILE=current_disk_tokenmap_pernode_$TSTAMP.txt
	;;
	-h)
		usage
		exit 1
